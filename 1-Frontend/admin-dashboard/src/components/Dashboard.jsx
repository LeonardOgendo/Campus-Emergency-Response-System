...
const Dashboard = () => {
    return(
        <>
            ...
            <div className='header p-2 mt-5 rounded'>
                <span className='fw-bold'>Most Student Occupancy Areas</span>
            </div>
            
            <div className="occ-area-map mt-3 mb-3">
                <iframe 
            ...
            <div className="occupied-areas">
                <div className="border py-4 px-3 rounded">
                    <span>Name: </span><span>Lurambi</span><br></br>
                    <span>Population: </span><span>3,000</span>    
                </div>
                <div className="border py-4 px-3 rounded">
                    <span>Name: </span><span>Sichirayi</span><br></br>
                    <span>Population: </span><span>5,000</span>
                </div>
                <div className="border py-4 px-3 rounded">
                    <span>Name: </span><span>Koromatangi</span><br></br>
                    <span>Population: </span><span>5,000</span>
                </div>
                <div className="border py-4 px-3 rounded">
                    <span>Name: </span><span>Kefinco</span><br></br>
