          ...
          <div className='card-body'>
            ...
            <div className='col-md-10 col-lg-6 order-1 order-lg-2 d-flex align-items-center'>
              ...
              <div className='col-md-10 col-lg-6 order-2 order-lg-1 d-flex flex-column align-items-center'>
                <p className='text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4 link-danger'>Sign up</p>
                ...
                <button className="btn custom-btn px-5 mb-3 btn-danger" style={{width: "100%"}}>Sign up</button>
                <p className="small fw-bold mt-2 pt-1 mb-2" >
              Have have an account? <a href="#" className="link-danger"><Link to="/">login</Link></a>
            </p>
              </div>
